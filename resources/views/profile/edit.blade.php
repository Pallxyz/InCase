    ...
    <div class="flex h-screen bg-background">
        ...
        <main class="scrollbar-none h-screen flex-1 overflow-y-auto lg:ml-64">
            <div class="mx-auto max-w-6xl px-6 py-8 sm:px-8">
                ...
                {{-- Single full-width column — semua card ditumpuk --}}
                <div class="mt-6 flex flex-col gap-6">
                    ...
                    <div class="rounded-[24px] border border-border bg-card p-6 shadow-sm">
                        ...
                        <div class="mt-4 flex flex-col gap-2.5 sm:flex-row">
                            <a href="{{ route('dashboard') }}" class="inline-flex flex-1 items-center gap-2.5 rounded-xl border border-border px-4 py-2.5 text-sm font-medium text-foreground transition-colors hover:bg-muted">
                                <x-icon.squares-2x2 class="h-4 w-4 text-muted-foreground" />
                                Lihat Dasbor
                            </a>
                            <a href="{{ route('items.index') }}" class="inline-flex flex-1 items-center gap-2.5 rounded-xl border border-border px-4 py-2.5 text-sm font-medium text-foreground transition-colors hover:bg-muted">
                                <x-icon.cube class="h-4 w-4 text-muted-foreground" />
                                Kelola Barang
                            </a>
                            <a href="{{ route('schedule.index') }}" class="inline-flex flex-1 items-center gap-2.5 rounded-xl border border-border px-4 py-2.5 text-sm font-medium text-foreground transition-colors hover:bg-muted">
                    ...
                    >
                        ...
                        <button
                            ...
                            class="mt-4 inline-flex items-center justify-center gap-2 rounded-full border border-destructive/30 px-4 py-2.5 text-sm font-semibold text-destructive transition-colors hover:bg-destructive/10"
                        >
